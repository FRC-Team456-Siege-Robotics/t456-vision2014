...
// original 4.0
         ...
         */
         if ( (polydp_contours->total < 7) && (polydp_contours->total > 3) )
         {
            /* 
            ...
            */
            ...
            /*
            **  Draw only the large (target) polygons
            */
            if ( area > 1000 ) {
               cvDrawContours( image, polydp_contours,
       ...
       */
       ...
       cvShowImage("Contours",image_thresh);
    }
