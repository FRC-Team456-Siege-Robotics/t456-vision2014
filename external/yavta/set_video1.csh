...
#
./yavta --set-control '0x009a0901 1' /dev/video1

#  
#  Set Absolute Exposure to 60
# control 0x009a0902 `Exposure (Absolute)' min 2 max 5000 step 1 default 312 
#
./yavta --set-control '0x009a0902 60' /dev/video1
